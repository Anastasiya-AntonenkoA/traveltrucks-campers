...
const Filters = ({ onSearch }: Props) => {
    ...
    const active = [];
    if (searchParams.get("AC")) active.push("AC");
    if (searchParams.get("transmission")) active.push("automatic");
    if (searchParams.get("kitchen")) active.push("kitchen");
    if (searchParams.get("TV")) active.push("TV");
    if (searchParams.get("bathroom")) active.push("bathroom");
    return active;
  });
    ...
    const handleSearch = () => {
      ...
      if (form) {
        params.form = form;
        urlParams.set("form", form);
      }

      features.forEach((feat) => {
      if (feat === "automatic") {
        params.transmission = "automatic";
        urlParams.set("transmission", "automatic");
      } else {
        params[feat] = true;
        urlParams.set(feat, "true");
      }
      });
